...
<?php endif; ?>
    ...
    <div class="marinatabContent">
        ...
        <div id="marina_vp" class="marina_vaziyet_plani">
				...
				<div class="ptadres"><p><?php echo $adres_text; ?></p><a href="https://www.google.com/maps/search/Yavuz+Sultan+Selim+Bulvar%C4%B1,+Jet-Kent+kar%C5%9F%C4%B1s%C4%B1,+Beykent+B%C3%BCy%C3%BCk%C3%A7ekmece%2F%C4%B0stanbul/@41.0115577,28.6233272,17z/data=!3m1!4b1" class="u_yol t2" target="_blank">YOL TARİFİ</a></div>
        ...
        <div id="marina_ornek_daire" class="marina_galeri relative">
            ...
            <div class="slidePopup2">
                <p>Ginza Residence Sosyal Tesis</p>
                
                <p>Ginza Residence, içerisinde Açık ve Kapalı Yüzme Havuzu 3.500 m2 iç Avlu, Hamam, Sauna, Spa ve Fitness Center barındıran bir sosyal tesise sahiptir.</p>
            </div>
