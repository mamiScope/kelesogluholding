    ...
    <div class="marinatabContent">
        ...
        <div id="marina_tasarim_mimari" class="marina_tasarim_mimari relative">
            ...
            <div class="popupText3">
                <h2>Flyinn Residence’nın Mimarı<br><span>HHS Mimarlık</span></h2>
        ...
        <div id="marina_ornek_daire" class="marina_galeri relative">
            ...
            <div class="slidePopup2">
                <p>Flyinn Residence Sosyal Tesis</p>
                
                <p>Hamam, Sauna, Açık & Kapalı Yüzme havuzu ve fitness salonu özelliklerini barındıran Flyinn Residence Sosyal Tesis'i daire sakinlerine tam donanımlı hizmet vermeye devam etmektedir.</p>
            </div>
