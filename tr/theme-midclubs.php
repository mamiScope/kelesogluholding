...
<?php if ($slideData['tabletmobile']) { ?>
        ...
        <div class="dark_row">
            <div class="container">
                ...
                <div class="yatirim_content absolute-center-y">
                    <h2>Her projeye <br>
                        farklı tasarımda <br>
                        <span style="color: #e2a022;">midclubs</span>
                    </h2>
                </div>
                <div class="clear"></div>
            </div>
    ...
    <div class="container">
        ...
        <div class="yatirim_content absolute-center-y midclubs-content">
            <p style="font-size: 38px; line-height: 1; color: #c6c6c6;">İstanbul'un en prestijli spor ve yaşam kulübü CennetKoru'da hizmetinizde !</p>
            <ul>
                <li>Açık kapalı yüzme havuzları</li>
                <li>Sauna</li>
                <li>Vitamin Bar</li>
                <li>Masa Tenisi</li>
                <li>Türk Hamamı</li>
            ...
            <p style="color:#c6c6c6;"> gibi birçok özellik barındıran midclubs markası sadece CennetKoru sakinlerinin hizmetinde olacak
            </p>
        </div>
        <div class="clear"></div>
    </div>
        ...
        <div class="dark_row">
            <div class="container">
                ...
                <div class="yatirim_content absolute-center-y">
                    <h2 class="h2D" style="text-align: right;">Denizİstanbul'un kalbinde !</h2>
                    <p style="text-align: right;">                        
                    
midclubs, konum olarak Denizİstanbul etaplarının tam ortasında, <strong style="color:#fff;">13.000</strong> m2 alan içerisinde  yer alıyor. Aynı anda <strong style="color:#fff;">250</strong> kişinin ferahlık içerisinde spor yapmasına imkan tanıyan, <strong style="color:#fff;">180</strong> araçlık otoparkı ve dinlenme alanlarıyla eksiksiz bir yaşam kulübü deneyimi vaadediyor. İçerisinde kullanılan lüks spor ekipmanları ve kullanıcı dostu çözümleri ile spor yapmanın keyfine varacaksınız. </p>
                </div>
                <div class="clear"></div>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="yatirim_content absolute-center-y midclubs-content">
            <h2>Denizİstanbul <span style="color: #e2a022;">midclubs</span> <br>
                <img src="<?php bloginfo('template_directory'); ?>/assets/images/gonye.png" alt="" class="gonyeLogo">tarafından <br>
            tasarlanmaktadır.</h2>
        </div>
        <div class="clear"></div>
    </div>
