...
function sendFormDatax() {
    ...
    var uber = $("#uber").is(':checked');
    $('.formOverlay').fadeIn();
    $.get("./save/save.php", {lang:1,name: firstName,grecaptcha:grecaptcha, surname: lastName, email: email, phone: phone,country: country, message: message, PermissionMarketingList: agreement, utmsource: utm_source, utmmedium: utm_medium, utmcampaign: utm_campaign, utmcontent: utm_content}, function (data) {
