    ...
    <div class="marinatabContent">
        ...
        <div id="marina_tasarim_mimari" class="marina_tasarim_mimari relative">
            ...
            <div class="popupText3">
                <h2>Ataköy Konakları’nın Mimarı<br><span>HHS Mimarlık</span></h2>
                <p>HHS Mimarlık insanların yaşamasını kolaylaştırmak için barınma, dinlenme, çalışma, eğlenme gibi eylemlerini sürdürebilmelerini sağlamak üzere projenin her aşamasında müşterilerinin taleplerine cevap verecek bilgi birikimine ve deneyime sahiptir.</p>

				<p>Yapıları ve fiziksel çevreyi uygun ölçülerde tasarlama ve inşa etme sanatıyla birleşen kağıt üzerinde müşterilerimize sunduğumuz tasarımların, farklı beklentileri karşılayacak kalitede, uygulama aşamasında ise hayallerin gerçeğe dönüşebildiğini gösterecek nitelikte olmasıdır.</p>
            </div>
        ...
        <div id="marina_ornek_daire" class="marina_galeri relative">
           <div class="ptdatatitle">midclubs</div>
            <div class="slidePopup2">
                <p>Ataköy Konakları Sosyal Tesis</p>
                
                <p>Ataköy Konutları sosyal tesis alanında basketbol, futbol, voleybol, tenis gibi saha oyunları, açık ve kapalı yüzme havuzları, fitness ve aerobik salonları, Türk hamamı, sauna, SPA, yürüyüş, koşu ve bisiklet parkurları gibi çok zengin seçenekler barındırıyor.</p>
            </div>
            <img src="<?php bloginfo('template_directory'); ?>/assets/images/projeler/vadistanbul.jpg" alt=""/>
            <div class="ptdatatitle">Sosyal Yaşam</div>
        </div>
        <div class="space100"></div>
    </div>
    <div class="clear"></div>
