...
<?php endif; ?>
    ...
    <div class="marinatabContent">
        ...
        <div id="marina_vp" class="marina_vaziyet_plani">
				...
				<div class="ptadres"><p><?php echo $adres_text; ?></p><a href="https://www.google.com/maps/place/Pelican+Hill+Residence/@41.0683379,28.6170113,17z/data=!3m1!4b1!4m8!3m7!1s0x14caa09baa803ac9:0x824350949d694201!5m2!1s2018-10-22!2i2!8m2!3d41.0683379!4d28.6192" class="u_yol t2" target="_blank">YOL TARİFİ</a></div>
        ...
        <div id="marina_tasarim_mimari" class="marina_tasarim_mimari relative">
            ...
            <div class="popupText3">
                <h2>PelicanHill Residence’nin mimarı<br><span>Proses Mimarlık</span></h2>
                <p>Proses Mimarlık, 2000 yılıdan bu yana, Y. Muh. Mimar Kent Plancısı R. Cihangir Tutluoğlu ve Mimar Selma Akkuş Ortaklığında, 1.5 milyon m2 üzerinde mimarı uygulama projeleri üretmiş ve imalat süreçlerinde danışmanlık görevi üstenmiştir.</p><p>Master ölçekli kent planlamasında, detay dekorasyon projelerine kadar olan tüm süreçlerde, çağın gereklerine uygun projeler üretmeye vakfı bir kuruluştur.</p><p>Değişen ve gelişen dünya ve ülke koşullarında, talepler doğrultusunda müşteri memnuniyetini öncelik adlederek, mimari hizmetlerini sürdürmektedir.</p>
            </div>
        ...
        <div id="marina_ornek_daire" class="marina_galeri relative">
            ...
            <div class="slidePopup2">
                <p>PelicanHill Residence Sosyal Tesis</p>
                
                <p>Açık / Kapalı Yüzme Havuzları , Fitness Center, Sauna ve Sosyal alanları ile birlikte 2 katlı tam kapasite bir spor kompleksi PelicanHill Residence sakinlerinin hizmetinde.</p>
            </div>
