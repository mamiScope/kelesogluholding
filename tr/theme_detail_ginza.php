    ...
    <div class="marinatabContent">
        ...
        <div id="marina_tasarim_mimari" class="marina_tasarim_mimari relative">
            ...
            <div class="popupText3">
                <h2>Ginza Lavinya Park’ın Mimarı<br>A Tasarım<br><span>Ali Osman Öztürk</span></h2>
                <p>Yüksek mimar Ali Osman Öztürk’ün 1997 yılında kurduğu A Tasarım Mimarlık; kentsel tasarım, karma kullanım, konut, ticari, ofis, konaklama, eğitim, araştırma, kamu ve kültür konularında proje hizmeti verir. Ağırlıklı olarak büyük ölçekli projeler gerçekleştiren A Tasarım, yapıları yakın çevresi ile düşünüp tasarlayarak yaşama katma konusunda önemli deneyimlere sahiptir.</p>

				<p>Nitelikli yaşam alanlarının oluşturulmasını önemseyen bir yaklaşımla tasarımlar gerçekleştiren A Tasarım; yatırımcılar, mühendislik grupları, peyzaj tasarım ekipleri ve danışmanlarla birlikte proje sürecini yürütür. Birlikte çalıştığı genç ve dinamik kadrosunda da ekiplerin sürekliliğine değer verir.</p>
            </div>
        ...
        <div id="marina_ornek_daire" class="marina_galeri relative">
            ...
            <div class="slidePopup2">
                <p>Ginza Lavinya Park Sosyal Tesis</p>
                
                <p>Ginza Lavinya Park Sosyal Tesis kapsamında sauna, restoran / cafei hamam, oyun parkı, SPA, kapalı yüzme havuzu gibi imkanlar barındırmakta.</p>
            </div>
