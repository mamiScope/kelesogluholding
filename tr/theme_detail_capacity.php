    ...
    <div class="marinatabContent">
        ...
        <div id="marina_tasarim_mimari" class="marina_tasarim_mimari relative">
            ...
            <div class="popupText3">
                <h2>Capacity AVM’nin mimarı<br><span>Chapman Taylor<br>CHRIS LANKSBURY</span></h2>
                <p>Chapman Taylor is an award-winning practice of global architects and masterplanners, known for designing places and buildings that are both creative and successful.<br><br>
...
Clients benefit from the breadth of our pooled knowledge and creative expertise across design studios in Asia, Europe and the Middle East.
            ...
            <div class="ptdatatitle">Tasarım ve Mimarilık</div>
        </div>
        <div class="space100"></div>
    </div>
    <div class="clear"></div>
