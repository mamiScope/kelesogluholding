...
<?php endif; ?>
    ...
    <div class="marinatabContent">
        ...
        <div id="marina_vp" class="marina_vaziyet_plani">
				...
				<div class="ptadres"><p><?php echo $adres_text; ?></p><a href="https://www.google.com/maps/place/Pelican+Hill+Residence/@41.0683379,28.6170113,17z/data=!3m1!4b1!4m8!3m7!1s0x14caa09baa803ac9:0x824350949d694201!5m2!1s2018-10-22!2i2!8m2!3d41.0683379!4d28.6192" class="u_yol t2" target="_blank">Get Direction</a></div>
        ...
        <div id="marina_tasarim_mimari" class="marina_tasarim_mimari relative">
            ...
            <div class="popupText3">
                <h2>Architect of PelicanHill Residence<br><span>Proses Mimarlık</span></h2>
        ...
        <div id="marina_ornek_daire" class="marina_galeri relative">
            ...
            <div class="slidePopup2">
                ...
                <p>A full capacity sports complex of 2 stories, accommodating Outdoor / Indoor Swimming pools, Fitness Center, Sauna, and Social facilities, is at the service of the residents of PelicanHill Residence.</p>
            </div>
