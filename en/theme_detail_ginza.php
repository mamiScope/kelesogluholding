...
<?php endif; ?>
	<div class="headSliderData relativeCont pageslidedata" style="background:url('<?php echo $featured_img_url; ?>') no-repeat top center;">
        <div class="head_logo">
            <img src="<?php bloginfo('template_directory'); ?>/assets/images/ginza_lavinya.svg" alt=""/>
        </div>
		<div class="clear"></div>
	</div>
	...
	<div class="marinaContent stickyWrapperContent" data-sticky_parent>
		<div class="tabCol"  data-sticky_column>
            ...
            <a class="gotoLink" href="#marina_example"><img src="<?php bloginfo('template_directory'); ?>/assets/images/marina_icon6.png" style="max-width:80px;" alt=""/>Show Float</a> 
    ...
    <div class="marinatabContent">
        ...
        <div id="marina_vp" class="marina_vaziyet_plani">
				...
				<div class="ptadres"><p><?php echo $adres_text; ?></p><a href="https://www.google.com/maps/place/Bar%C4%B1%C5%9F+Mahallesi,+Mehmet%C3%A7ik+Cd.+No:30,+34520+Beylikd%C3%BCz%C3%BC+Osb%2FBeylikd%C3%BCz%C3%BC%2F%C4%B0stanbul/@41.0115577,28.6233272,17z/data=!4m5!3m4!1s0x14b55f98cc632b05:0x6ad469fd59c369b9!8m2!3d41.0041057!4d28.651556" class="u_yol t2" target="_blank">Get Direction</a></div>
        ...
        <div id="marina_tasarim_mimari" class="marina_tasarim_mimari relative">
            ...
            <div class="popupText3">
                <h2>Architect of Ginza Lavinya Park<br>A Tasarım<br><span>Ali Osman Öztürk</span></h2>
                <p>A Tasarım Mimarlık founded in 1997 by Mr. Ali Osman Öztürk, Master Architect, provides project services in urban design, combines utilization, housing, commercial buildings, offices, lodgings, education, research, public and culture. A Tasarım accomplishes mainly large scale projects and has substantial experience for bringing structures into life in consideration of their close surroundings.
<br><br>
Designing with an approach of caring to create quality living spaces, A Tasarım carries out the process of projects together with investors, group of engineers, landscape designers, and consultants. It places importance on the continuity of young and dynamic professional staff.
</p>
            </div>
        ...
        <div id="marina_example" class="marina_galeri relative">
            ...
            <div class="ptdatatitle">Show Float</div>
        </div>
        ...
        <div class="space100"></div>
         <div id="marina_ornek_daire" class="marina_galeri relative">
            ...
            <div class="slidePopup2">
                <p>Ginza Lavinya Park Social Facilit</p>
                
                <p>Ginza Lavinya Park Social Facility accommodates such opportunities as sauna, restaurant / cafe, bath, play grounds, SPA, and indoor swimming pool.</p>
            </div>
            <img src="<?php bloginfo('template_directory'); ?>/assets/images/projeler/ginzalavinya.jpg" alt=""/>
