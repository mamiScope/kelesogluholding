...
<?php endif; ?>
	<div class="headSliderData relativeCont pageslidedata" style="background:url('<?php echo $featured_img_url; ?>') no-repeat top center;">
        <div class="head_logo">
            <img src="<?php bloginfo('template_directory'); ?>/assets/images/autopia.svg" alt=""/>
        </div>
		<div class="clear"></div>
	</div>
    ...
    <div class="marinatabContent">
        ...
        <div id="marina_vp" class="marina_vaziyet_plani">
				...
				<div class="ptadres"><p><?php echo $adres_text; ?></p><a href="https://www.google.com/maps/search/Atat%C3%BCrk+Mahallesi,+E-5+%C3%9Czeri,+Adnan+Kahveci,+34522+Beylikd%C3%BCz%C3%BC%2F%C4%B0stanbul/@41.0210619,28.6331507,17z/data=!3m1!4b1" class="u_yol t2" target="_blank">Get Direction</a></div>
        ...
        <div id="marina_tasarim_mimari" class="marina_tasarim_mimari relative">
            ...
            <div class="popupText3">
                <h2>Architect of Autopia<br><span>Dara Kırmızıtoprak</span></h2>
                <p>Born in 1962 in Ankara, I graduated from İTÜ Faculty of Architecture in 1982. I must admit I was luckier than those architects of previous periods that for my education and professional working life coincided to the period when Turkish people was already in permanent settlements, living in same housing or neighborhood, having lasting social objectives and accordingly, started to care their living and working quarters, I had the chance of to practice my profession easily and with plenty of means. Furthermore, I must say that we are actually witnessing and pioneering a period of substantial architectural lift-off with abundance of materials (firstly with import and then, production), open-minded and daring approach of client range, and advanced traveling and communication opportunities.</p>
            </div>
        ...
        <div id="marina_tasarim_mimari" class="marina_tasarim_mimari relative">
            ...
            <div class="popupText3">
                <h2>Architect of Autopia<br><span>Gökhan Avcıoğlu</span></h2>
                <p>He founded GAD (Global Architectural Development) company in Istanbul in 1994, and GAD Foundation in 2014 in order to conduct and share studies on architecture and settlement culture. These two different organizations founded by Gökhan Avcıoğlu, who completed his architectural education at KSÜ, develops and regularly shares intellectual ideas through various channels on construction and development techniques as well as architectural heritage, architectural space, present-day needs, future lives, and even, living on other planets.
<br><br>
He created over 250 projects by means of the GAD office in 25 years for different functions and varying stages, and accomplished constructions of several of them.</p>
            </div>
            <div class="ptdatatitle">Design and Architecture</div>
        </div>
        <div class="space100"></div>
