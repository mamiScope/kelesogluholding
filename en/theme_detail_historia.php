    ...
    <div class="marinatabContent">
        ...
        <div id="marina_tasarim_mimari" class="marina_tasarim_mimari relative">
            ...
            <div class="popupText3">
                <h2>Architect of Historia AVM<br><span>Proses Mimarlık</span></h2>
				<p>Proses Mimarlık in the partnership of Mr. R. Cihangir Tutluoğlu, Master Engineer and Architect and Urban Planner and Ms. Selma Akkuş, Architect, produced architectural application projects of 1.5 million m2 and undertook consultancy thereon since 2000.It is an organization able to produce such projects suitable to the needs of the time in all the processes up to master-scaled urban planning, detailed decoration projects.It continues to provide its architectural services in consideration of customer satisfaction as priority under the changing and developing conditions of the world and the country and based in line with demands.</p>
            </div>
