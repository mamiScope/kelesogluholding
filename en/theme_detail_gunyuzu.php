...
<?php endif; ?>
    ...
    <div class="marinatabContent">
        ...
        <div id="marina_vp" class="marina_vaziyet_plani">
				...
				<div class="ptadres"><p><?php echo $adres_text; ?></p><a href="https://www.google.com/maps/place/Acarlar+Mahallesi,+34800+Beykoz%2F%C4%B0stanbul/@41.1092777,29.1155732,15z/data=!3m1!4b1!4m5!3m4!1s0x14cacb7100865f39:0x484a8cb3be508558!8m2!3d41.1092509!4d29.1245255" class="u_yol t2" target="_blank">Get Direction</a></div>
        ...
        <div id="marina_tasarim_mimari" class="marina_tasarim_mimari relative">
            ...
            <div class="popupText3">
                <h2>Architect of Günyüzü Konakları<br><span>Keleşoğlu Architecture</span></h2>
        ...
        <div id="marina_ornek_daire" class="marina_galeri relative">
            ...
            <div class="slidePopup2">
                <p>Günyüzü Konakları Social Facility</p>
                
                <p>Günyüzü Konakları integrates a quiet and serene life style with social activities. Many activities in/at swimming pool, tennis court, squash, fitness center, Turkish bath, sauna, and an observation terrace await you.</p>
            </div>
