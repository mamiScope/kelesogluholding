...
<?php endif; ?>
    ...
    <div class="marinatabContent">
        ...
        <div id="marina_vp" class="marina_vaziyet_plani">
				...
				<div class="ptadres"><p><?php echo $adres_text; ?></p><a href="https://www.google.com/maps/search/Yavuz+Sultan+Selim+Bulvar%C4%B1,+Jet-Kent+kar%C5%9F%C4%B1s%C4%B1,+Beykent+B%C3%BCy%C3%BCk%C3%A7ekmece%2F%C4%B0stanbul/@41.0115577,28.6233272,17z/data=!3m1!4b1" class="u_yol t2" target="_blank">Get Direction</a></div>
        ...
        <div id="marina_tasarim_mimari" class="marina_tasarim_mimari relative">
            ...
            <div class="popupText3">
                <h2>Architect of Ginza Residence<br><span>Keleşoğlu Architecture</span></h2>
                <p>Keleşoğlu Architecture has accomplished many innovative and sustainable projects. Having blended its experiences of the past with the team of experts in their fields, it created high-quality living quarters. The projects it designed and built have high values even today at their locations. The most important of such projects are Yasemin Konakları, Ginza Residence, and Günyüzü Konakları. 
</p>
            </div>
        ...
        <div id="marina_ornek_daire" class="marina_galeri relative">
            ...
            <div class="slidePopup2">
                <p>Ginza Residence Social Facility</p>
                
                <p>Ginza Residence has a social facility, accommodating Outdoor and Indoor pools, an inner court of 3,500 sq meters, Bath, Sauna, Spa, and Fitness Center.</p>
            </div>
