...
<?php endif; ?>
    ...
    <div class="marinatabContent">
        ...
        <div id="marina_vp" class="marina_vaziyet_plani">
				...
				<div class="ptadres"><p><?php echo $adres_text; ?></p><a href="https://www.google.com/maps/search/vadi+istanbul+avm/@41.1061812,28.9851227,17z/data=!3m1!4b1" class="u_yol t2" target="_blank">Get Direction</a></div>
		...
		<div id="marina_tasarim_mimari" class="marina_tasarim_mimari relative">
            ...
            <div class="popupText3">
                <h2>Architect of Vadistanbul<br><span>iki design</span></h2>
                <p>iki design group is committed to develop dynamic and interactive space arrangements that are sensitive to culture and climate. The practice is driven with a particular attention to address a holistic approach in which from master planning to product design are assumed to be the integral part of the service. Devoting attention to promote the values of “inspiring” and “connecting” results in innovative structural designs and enhanced public realm that are both responsive to the context and function along with client’s aspirations.</p>
            </div>
            <div class="ptdatatitle">Design and Architecture</div>
        </div>
        <div class="space100"></div>
        ...
        <div id="marina_ornek_daire" class="marina_galeri relative">
           <div class="ptdatatitle">midclubs</div>
            <div class="slidePopup2">
                <p>Vadistanbul Social Facility</p>
                
                <p>Having starting to serve in 2015 for raising the awareness of "Sports and Healthy Living" to its neighbors, Vadistanbul social facilities campaign for reaching to the target as soon as possible in line to the aim in every aspect necessary sektörel by quickly adapting to developments. To protect your health, increase quality of your living conditions, and strengthen your neighborhood relations and social networks are part of this campaign. Just "Take Action".</p>
            </div>
