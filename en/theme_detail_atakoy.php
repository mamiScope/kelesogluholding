    ...
    <div class="marinatabContent">
        ...
        <div id="marina_tasarim_mimari" class="marina_tasarim_mimari relative">
            ...
            <div class="popupText3">
                <h2>Architect of Ataköy Konakları<br><span>HHS Mimarlık</span></h2>
                <p>HHS Mimarlık has the knowledge and experience to respond the demands of clients in every stage of projects in order to ensure that people continue their activities of housing, resting, working, and having fun and facilitating their lives.
<br><br>
        ...
        <div id="marina_ornek_daire" class="marina_galeri relative">
           <div class="ptdatatitle">midclubs</div>
            <div class="slidePopup2">
                <p>Ataköy Konakları Social Life</p>
                
                <p>Ataköy Konutları social facilities accommodate a large variety of options, such as courts for basketball, football, volleyball, and tennis, outdoor and indoor pools, fitness and aerobic exercises, Turkish bath, sauna, SPA, and tracks for walking, jogging, and cycling.</p>
            </div>
