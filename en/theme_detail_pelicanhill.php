...
<?php endif; ?>
    ...
    <div class="marinatabContent">
        ...
        <div id="marina_vp" class="marina_vaziyet_plani">
				...
				<div class="ptadres"><p><?php echo $adres_text; ?></p><a href="https://www.google.com/maps/place/Pelican+Hill+Evleri/@41.068563,28.6135493,17z/data=!3m1!4b1!4m5!3m4!1s0x14b5592520272fd3:0x204ff00300664bb0!8m2!3d41.068563!4d28.615738" class="u_yol t2" target="_blank">Get Direction</a></div>
        ...
        <div id="marina_tasarim_mimari" class="marina_tasarim_mimari relative">
            ...
            <div class="popupText3">
                <h2>Architect of PelicanHill<br><span>RNM Design</span></h2>
                <p>ROBERT F. TYLER AIA<br>BAŞKAN/CEO</p>

				<p>Among the responsibilities of Mr. Tyler, RNM President and CEO, are planning housing, commercial and accommodation projects as well as customer interface focused on architectural design, project management and design. Mr. Tyler has an experience of more than 20 years in architecture and planning, and participated to the designs of housing projects, urban and holiday hotels, shopping and office buildings in the American, European, and Asian markets.
</p>
            </div>
        ...
        <div id="marina_ornek_daire" class="marina_galeri relative">
            ...
            <div class="slidePopup2">
                ...
                <p>Our social facilities, which are for use only by the residents of the Pelican Hill complex, have a rather large and comfortable usage area of 6000 sq meters. Our social facilities include an outdoor pool in the dimensions of Olympic games besides a heated indoor pool, Turkish Bath authentically designed, Sauna and Steam Room with large usage areas, unique-design massage rooms available in company of a masseur/masseuse, a Fitness Center equipped a large range of fitness equipments available for use in company of special trainers if requested, children recreation room available to children in company of nurses, and an amusement pool with slides for children.</p>
            </div>
