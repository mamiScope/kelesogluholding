...
<?php endif; ?>
    ...
    <div class="marinatabContent">
        ...
        <div id="marina_vp" class="marina_vaziyet_plani">
				...
				<div class="ptadres"><p><?php echo $adres_text; ?></p><a href="https://www.google.com/maps/search/G%C3%B6kt%C3%BCrk+Merkez+Mahallesi,+no:,+%C4%B0stanbul+Cd.+No:30,+34077+Ey%C3%BCp%2F%C4%B0stanbul/@41.1797878,28.8860149,17z/data=!3m1!4b1" class="u_yol t2" target="_blank">Get Direction</a></div>
        ...
        <div id="marina_tasarim_mimari" class="marina_tasarim_mimari relative">
            ...
            <div class="popupText3">
                <h2>Architect of Country Life<br><span>Ömer Çamoğlu</span></h2>
                <p>Çamoğlu Mimarlık, founded by in the leadership of Ömer Çamoğlu, who graduated from İ.T.Ü. Faculty of Architecture in 1975, provides projects, consultancy, application, and inspection services, domestically and abroad, since 1978.
<br><br>
Having the sense of responsibility increased day by day by the satisfaction of investors and users, and several domestic and foreign awards for the accomplished projects, Çamoğlu Mimarlık proudly continues to put its signature on complete planning of application and detail projects, application consultancy services, urban renewal, master plan-concept project works.
</p>
            </div>
        ...
        <div id="marina_ornek_daire" class="marina_galeri relative">
           <div class="ptdatatitle">midclubs</div>
            <div class="slidePopup2">
                <p>Country Life Social Facility</p>
                
                <p>A sports and living club filled with activities in swimming pool, fitness center, bath, steam room, recreation room, massage, and daily activities.</p>
            </div>
            <img src="<?php bloginfo('template_directory'); ?>/assets/images/projeler/countrylife.jpg" alt=""/>
            <div class="ptdatatitle">Sosyal Facility</div>
        </div>
        <div class="space100"></div>
    </div>
    <div class="clear"></div>
