<?php
/*
 * Template Name: Detail Pelican Mall
 */
?>
<!doctype html>
<head>
...
<?php endif; ?>
	<div class="headSliderData relativeCont pageslidedata" style="background:url('<?php echo $featured_img_url; ?>') no-repeat top center;">
        <div class="head_logo">
            <img src="<?php bloginfo('template_directory'); ?>/assets/images/pelicanmall.svg" alt=""/>
        </div>
		<div class="clear"></div>
	</div>
    ...
    <div class="marinatabContent">
        ...
        <div id="marina_vp" class="marina_vaziyet_plani">
				...
				<div class="ptadres"><p><?php echo $adres_text; ?></p><a href="https://www.google.com/maps/place/Pelican+Mall+AVM/@40.9908492,28.7130125,17z/data=!3m1!4b1!4m5!3m4!1s0x14caa055dbbfcfcf:0x5219542b4a00bebd!8m2!3d40.9908492!4d28.7152012" class="u_yol t2" target="_blank">Get Direction</a></div>
        ...
        <div id="marina_tasarim_mimari" class="marina_tasarim_mimari relative">
            ...
            <div class="popupText3">
                <h2>Architect of PelicanMall AVM<br><span>Murat Tabanlıoğlu</span></h2>
                <p>Born in 1960 in Istanbul, Mr. Murat Tabanlıoğlu completed his education in the period of 1978-1992. Graduated from Department of Architecture at Vienna Technical University, Mr. Tabanlıoğlu founded Tabanlıoğlu Architecture Company in 1990 together with his father Dr. Hayati Tabanlıoğlu. His works were awarded with several prizes including two grand prizes as TMMOB Building Achievement prize, and Cityscape Architectural Review in Dubai.
<br><br>
Mr. Tabanlıoğlu is a member of Chamber of Architects, Association of Turkish Independent Architects, International Union of Shopping Centers, Istanbul Haliç Rotary Club, GYİAD, Taç Foundation Steering Committee, TEGV Board of Trustees, Structural Steel Association as well as special jury and teaching fellow at several universities.
</p>
            </div>
