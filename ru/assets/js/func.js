...
$(document).ready(function () {
    ...
    $("#btnSend").on("click", function (e) {
        ...
        var genelkvkk=$('#genelkvkk');
if(!genelkvkk.prop("checked")){
    genelkvkk.closest('label').append('<label class="error">Lütfen Tıklayın.</label>');
    error++;
}
// var camerakvkk=$('#camerakvkk');
// if(!camerakvkk.prop("checked")){
//     camerakvkk.closest('label').append('<label class="error">Lütfen Tıklayın.</label>');
//     error++;
// }
...
function sendFormDatax() {
    ...
    var uber = $("#uber").is(':checked');
    $('.formOverlay').fadeIn();
    $.get("../../save/save.php", {lang:5,name: firstName, surname: lastName,grecaptcha:grecaptcha, email: email, phone: phone,country: country, message: message, PermissionMarketingList: agreement, utmsource: utm_source, utmmedium: utm_medium, utmcampaign: utm_campaign, utmcontent: utm_content}, function (data) {
