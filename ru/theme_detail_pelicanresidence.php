<?php
/*
 * Template Name: Detail Pelican Residence
 */
?>
<!doctype html>
<head>
...
<?php endif; ?>
	<div class="headSliderData relativeCont pageslidedata" style="background:url('<?php echo $featured_img_url; ?>') no-repeat top center;">
        <div class="head_logo">
            <img src="<?php bloginfo('template_directory'); ?>/assets/images/pelicanhill_residence.svg" alt=""/>
        </div>
		<div class="clear"></div>
	</div>
    ...
    <div class="marinatabContent">
        ...
        <div id="marina_vp" class="marina_vaziyet_plani">
				...
				<div class="ptadres"><p><?php echo $adres_text; ?></p><a href="https://www.google.com/maps/place/Pelican+Hill+Residence/@41.0683379,28.6170113,17z/data=!3m1!4b1!4m8!3m7!1s0x14caa09baa803ac9:0x824350949d694201!5m2!1s2018-10-22!2i2!8m2!3d41.0683379!4d28.6192" class="u_yol t2" target="_blank">Схема проезда</a></div>
        ...
        <div id="marina_tasarim_mimari" class="marina_tasarim_mimari relative">
            ...
            <div class="popupText3">
                <h2>«Proses Mimarlık», архитектор резиденции ПеликанХилл<br><span>«Proses Mimarlık», архитектор ТЦ «Хисториа»,</span></h2>
                <p>с 2000 года и по настоящее время, в партнерстве с инженером-архитектором магистром и градостроителем Р. Джихангиром Тутлуоглу и архитектором Селмой Аккуш разработала прикладные проекты для застройки свыше 1.5 млн м2 и работала консультантом в производственных процессах.
                </p>
                <p>Это профессиональная организация, которая занимается разработкой проектов в соответствии с требованиями эпохи на каждом этапе, начиная от масштабного городского генплана, и заканчивая детальными проектами отделки.</p>
                <p>Продолжает оказывать архитектурные услуги в условиях меняющегося и развивающегося мира и страны, сделав своим приоритетом удовлетворенность клиентов и соответствие требованиям.</p>
            </div>
        ...
        <div id="marina_ornek_daire" class="marina_galeri relative">
            ...
            <div class="slidePopup2">
                <p>Социальный объект резиденции ПеликанХилл </p>
                <p>Резиденции ПеликанХилл предлагает к услугам своих жителей открытый/крытый бассейн, фитнес-центр, сауну и социальные зоны и полностью оснащенный 2-х этажный спортивный комплекс.</p>
            </div>
            <img src="<?php bloginfo('template_directory'); ?>/assets/images/projeler/pelicanhillresidence.jpg" alt=""/>
