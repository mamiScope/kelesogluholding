<?php
/*
 * Template Name: Detail Flyin Residence
 */
?>
<!doctype html>
<head>
...
<?php endif; ?>
	<div class="headSliderData relativeCont pageslidedata" style="background:url('<?php echo $featured_img_url; ?>') no-repeat top center;">
        <div class="head_logo">
            <img src="<?php bloginfo('template_directory'); ?>/assets/images/flyinn_residence.svg" alt=""/>
        </div>       
		<div class="clear"></div>
	</div>
    ...
    <div class="marinatabContent">
        ...
        <div id="marina_vp" class="marina_vaziyet_plani">
				...
				<div class="ptadres"><p><?php echo $adres_text; ?></p><a href="https://www.google.com/maps/place/%C5%9Eenlikk%C3%B6y+Mahallesi,+%C4%B0nci+Sk.,+34153+Bak%C4%B1rk%C3%B6y%2F%C4%B0stanbul/@40.9750378,28.800494,17z/data=!3m1!4b1!4m5!3m4!1s0x14caa3ae35d6d653:0x89c8f36a2291b60d!8m2!3d40.9750378!4d28.8026827" class="u_yol t2" target="_blank">Схема проезда</a></div>
        ...
        <div id="marina_tasarim_mimari" class="marina_tasarim_mimari relative">
            ...
            <div class="popupText3">
                <h2>Архитектор резиденции Флайинн (Flyinn)<br><span>«ХХС Мимарлык» (HHS Mimarlık)</span></h2>
        ...
        <div id="marina_ornek_daire" class="marina_galeri relative">
            ...
            <div class="slidePopup2">
                <p>Социальный объект резиденции Флайинн</p>
                <p>Социальный объект резиденции Флайинн, имеющий турецкую баню, открытый и крытый плавательные бассейны и фитнес-зал, предлагает жителям комплекса услуги с полным оснащением.</p>
            </div>
            <img src="<?php bloginfo('template_directory'); ?>/assets/images/projeler/flyinn-residence.jpg" alt=""/>
