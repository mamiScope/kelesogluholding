<?php
/*
 * Template Name: Detail Ataköy Konak
 */
?>
<!doctype html>
<head>
...
<?php endif; ?>
	<div class="headSliderData relativeCont pageslidedata" style="background:url('<?php echo $featured_img_url; ?>') no-repeat top center;">
        <div class="head_logo">
            <img src="<?php bloginfo('template_directory'); ?>/assets/images/atakoy.svg" alt=""/>
        </div>
		<div class="clear"></div>
	</div>
    ...
    <div class="marinatabContent">
        ...
        <div id="marina_vp" class="marina_vaziyet_plani">
				...
				<div class="ptadres"><p><?php echo $adres_text; ?></p><a href="https://www.google.com/maps/place/Atak%C3%B6y+2-5-6.+Mahallesi,+TOK%C4%B0+Atak%C3%B6y+Konutlar%C4%B1,+34158+Bak%C4%B1rk%C3%B6y%2F%C4%B0stanbul/@40.9767573,28.8466788,17z/data=!3m1!4b1!4m5!3m4!1s0x14caa348840fa8d1:0x10525d3f79e71e75!8m2!3d40.9767573!4d28.8488675" class="u_yol t2" target="_blank">Схема проезда</a></div>
        ...
        <div id="marina_tasarim_mimari" class="marina_tasarim_mimari relative">
            ...
            <div class="popupText3">
                <h2>Архитектор жилых зданий Атакёй<br><span>«ХХС Мимарлык» (HHS Mimarlık)</span></h2>
                <p>«HHS Mimarlık» обладает достаточными знаниями и опытом, чтобы найти ответ на запросы клиентов на каждом этапе проекта, стремясь облегчить жизнь людей и обеспечить устойчивость в таких вопросах, как жилье, отдых, работа, развлечения.</p>
                <p>Проекты, которые мы предлагаем нашим клиентам на бумаге в соответствующем масштабе, объединяют искусство проектирования и строительства структур и физической среды, являются качественными в плане удовлетворения различных ожиданий и на этапе реализации  показывают, что мечты могут стать реальностью.</p>
            </div>
        ...
        <div id="marina_ornek_daire" class="marina_galeri relative">
           <div class="ptdatatitle">midclubs</div>
            <div class="slidePopup2">
                <p>Социальный объект жилого комплекса Атакёй</p>
                <p>Территория социального объекта жилого комплекса Атакёй, предлагает богатый выбор таких полевых игр, как баскетбол, футбол, волейбол, теннис, крытый и открытый плавательные бассейны, залы для занятия фитнесом и аэробикой, турецкая баня, сауна, спа-центр, пешеходные, беговые и велосипедные дорожки.</p>
            </div>
