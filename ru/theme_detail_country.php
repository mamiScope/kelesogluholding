...
<?php endif; ?>
	<div class="headSliderData relativeCont pageslidedata" style="background:url('<?php echo $featured_img_url; ?>') no-repeat top center;">
        <div class="head_logo">
            <img src="<?php bloginfo('template_directory'); ?>/assets/images/countrylife.svg" alt=""/>
        </div>
		<div class="clear"></div>
	</div>
    ...
    <div class="marinatabContent">
        ...
        <div id="marina_vp" class="marina_vaziyet_plani">
				...
				<div class="ptadres"><p><?php echo $adres_text; ?></p><a href="https://www.google.com/maps/search/G%C3%B6kt%C3%BCrk+Merkez+Mahallesi,+no:,+%C4%B0stanbul+Cd.+No:30,+34077+Ey%C3%BCp%2F%C4%B0stanbul/@41.1797878,28.8860149,17z/data=!3m1!4b1" class="u_yol t2" target="_blank">Схема проезда</a></div>
        ...
        <div id="marina_tasarim_mimari" class="marina_tasarim_mimari relative">
            ...
            <div class="popupText3">
                <h2>Архитектор Country Life<br><span>Омер Чамоглу</span></h2>
                <p>«Чамоглу Мимарлык», учрежденная в 1975 году, по инициативе Омера Чамоглу, выпускника архитектурного факультета СТУ, с 1978 года и по настоящее время  в стране и за рубежом предоставляет услуги, связанные с разработкой проектов, консультациями, реализацией и надзором.</p>
                <p>«Чамоглу Мимарлык», с осознанием того, что проекты, разрабатываемые с комплексными услугами по проектированию прикладных-детальных проектов, включая консультационные услуги по реализации, городской трансформации и подготовке генеральных планов-концепций, различные награды, полученные за выполненные в стране и за рубежом проекты и сформированная компанией удовлетворенность инвесторов и пользователей, повышают ответственность, продолжает ставить подпись компании под новыми достижениями.</p>
            </div>
        ...
        <div id="marina_ornek_daire" class="marina_galeri relative">
           <div class="ptdatatitle">midclubs</div>
            <div class="slidePopup2">
                <p>Социальный объект Country Life </p>
                <p>Клуб спорта и жизни оснащен бассейном, фитнесом, турецкой баней, парилкой, комнатой отдыха, массажным кабинетом и наполнен повседневными мероприятиями.</p>
            </div>
            <img src="<?php bloginfo('template_directory'); ?>/assets/images/projeler/countrylife.jpg" alt=""/>
