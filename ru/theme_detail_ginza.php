    ...
    <div class="marinatabContent">
        ...
        <div id="marina_tasarim_mimari" class="marina_tasarim_mimari relative">
            ...
            <div class="popupText3">
                <h2>Архитектором объекта Гинза Лавинья Парк является Али Осман Озтюрк и архитектором ТЦ «Метропорт»
                    <br>
                    <span>Дара Кырмызытопрак из «А Тасарым Мимарлык» </span></h2>
        ...
        <div class="space100"></div>
         <div id="marina_ornek_daire" class="marina_galeri relative">
            ...
            <div class="slidePopup2">
                <p>Социальный объект Гинза Лавинья Парк</p>
                <p>В рамках социального объекта Гинза Лавинья Парк предоставляется возможность воспользоваться услугами сауны, ресторана/кафе, турецкой бани, игрового парка, СПА, крытого бассейна.</p>
            </div>
